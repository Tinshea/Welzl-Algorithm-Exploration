...
public class TestScalabilitenaif {
	public static void main(String[] args) {
	    ...
	    try {
	        timeWriter = new PrintWriter("./CSV/executionTimesScalable.csv", "UTF-8");

	        // En-têtes pour les fichiers CSV
	        timeWriter.println("Nombre de points, Temps d'execution_AlgoNaif (ms)");
	        int i = 0;
